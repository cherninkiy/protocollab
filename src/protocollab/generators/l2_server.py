"""Python L2 Scapy server generator for `protocollab`."""
...
class L2ServerGenerator(BaseGenerator):
    """Generate a Python Scapy L2 server for a protocol parser."""
    ...
    def generate(self, spec: Dict[str, Any], output_dir: Path) -> List[Path]:
        ...
        output_file = output_dir / f"{proto_id}_l2_server.py"
        ...
        template = env.get_template("l2_server.py.j2")
