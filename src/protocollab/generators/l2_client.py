"""Python L2 Scapy client generator for `protocollab`."""
...
class L2ClientGenerator(BaseGenerator):
    """Generate a Python Scapy L2 client for a protocol parser."""
    ...
    def generate(self, spec: Dict[str, Any], output_dir: Path) -> List[Path]:
        ...
        output_file = output_dir / f"{proto_id}_l2_client.py"
        ...
        template = env.get_template("l2_client.py.j2")
