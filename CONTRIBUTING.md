...
Because security is a core feature of `protocollab`, any changes that affect the loading or processing of YAML must be reviewed with extra care. If you discover a potential security vulnerability, please do NOT open an issue; instead, send an email to [security@protocollab.dev](mailto:security@protocollab.dev).
